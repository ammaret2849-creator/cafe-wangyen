...
export const FileImportModal: React.FC<FileImportModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/70 p-3 sm:p-5 backdrop-blur-xs overflow-y-auto">
      <div 
        className="relative flex max-h-[92vh] w-full max-w-5xl flex-col overflow-hidden rounded-2xl bg-white border border-slate-200 text-slate-900 shadow-2xl animate-in fade-in zoom-in-95 duration-200"
          ...
          <div className="flex items-center gap-2">
            {parseResult && (
              <button
                ...
                className="hidden sm:flex items-center gap-1.5 rounded-xl border border-slate-300 bg-white px-3 py-1.5 text-xs font-semibold text-slate-700 hover:bg-slate-100 transition-colors shadow-2xs"
              >
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center justify-between border-b border-slate-200 pb-3">
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 rounded-xl bg-amber-50 border border-amber-200 px-3.5 py-1.5 text-xs font-bold text-amber-800 hover:bg-amber-100 transition-colors shadow-2xs"
                >
                ...
                <div
                  ...
                  className={`group relative flex flex-col items-center justify-center rounded-2xl border-2 border-dashed p-10 text-center transition-all cursor-pointer ${
                    isDragging
                      ...
                      : 'border-slate-300 bg-slate-50/60 hover:border-emerald-500 hover:bg-emerald-50/30'
                  }`}
                >
                  <input
                    ref={fileInputRef}
                  ...
                  <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-white shadow-md border border-slate-200 text-emerald-600 group-hover:scale-110 transition-transform">
                  ...
                  <p className="mt-1.5 text-xs text-slate-500 max-w-md">
                    รองรับไฟล์ <strong className="text-slate-700">Excel (.xlsx, .xls)</strong>, <strong className="text-slate-700">CSV (.csv)</strong>, รายงาน POS หรือ Statement บัญชีธนาคาร
                  </p>

                  <div className="mt-6 flex flex-wrap items-center justify-center gap-2 text-[11px] text-slate-500">
                    <span className="rounded-md bg-white px-2.5 py-1 font-semibold border border-slate-200 shadow-2xs">
                      📊 Excel Spreadsheets
                    </span>
                    <span className="rounded-md bg-white px-2.5 py-1 font-semibold border border-slate-200 shadow-2xs">
                      📑 CSV Files
...
2026-08-02	ขายเค้กและขนม	เบเกอรี่ & ขนม	รายรับ	2100	เงินสด"
                    className="w-full rounded-2xl border border-slate-300 bg-slate-50 p-4 font-mono text-xs text-slate-900 focus:border-emerald-600 focus:bg-white focus:outline-none transition-colors"
                  />
                  <div className="flex items-center justify-between">
                    <button
                      type="button"
                    ...
                    <button
                      ...
                      className="flex items-center gap-1.5 rounded-xl bg-emerald-600 px-5 py-2 text-xs font-bold text-white hover:bg-emerald-700 transition-colors disabled:opacity-50 shadow-xs"
                    >
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      className="flex items-center gap-1.5 rounded-xl border border-slate-300 bg-white px-3 py-1.5 text-xs font-bold text-slate-700 hover:bg-slate-100 hover:text-emerald-700 transition-colors shadow-2xs"
                    >
          ...
          {parseResult && (
            <div className="space-y-6">
              {/* File Info Banner */}
              <div className="flex flex-wrap items-center justify-between gap-3 rounded-2xl bg-slate-900 text-white p-4 shadow-md">
                <div className="flex items-center gap-3">
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="flex items-center gap-1.5 rounded-xl bg-slate-800 hover:bg-slate-700 text-white px-3 py-1.5 text-xs font-semibold border border-slate-700 transition-colors"
                  >
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-3.5">
                ...
                <div className={`rounded-2xl border p-4 ${
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className={`flex h-7 w-7 items-center justify-center rounded-lg text-white shadow-2xs ${
                      dynamicStats.netProfit >= 0 ? 'bg-indigo-600' : 'bg-amber-600'
                    }`}>
                ...
                <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                  <div className="flex items-center justify-between">
                    <span className="text-xs font-bold text-slate-700">อัตรากำไร (Margin)</span>
                    <div className="flex h-7 w-7 items-center justify-center rounded-lg bg-slate-800 text-white shadow-2xs">
                      <Percent className="h-4 w-4" />
                    </div>
                  </div>
                  <div className="mt-2 font-bold text-xl sm:text-2xl text-slate-900 tracking-tight">
              ...
              {showCharts && (
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
                  ...
                  <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-2xs">
                    <h5 className="font-bold text-xs text-slate-800 flex items-center gap-1.5 mb-2">
              ...
              <div className="space-y-3 pt-2">
                  ...
                  <div className="flex flex-wrap items-center gap-2 w-full sm:w-auto">
                    ...
                    <div className="relative flex-1 sm:w-48">
                      ...
                      <input
                        ...
                        className="w-full rounded-xl border border-slate-200 bg-slate-50 pl-8 pr-3 py-1 text-xs text-slate-900 focus:bg-white focus:border-indigo-600 focus:outline-none"
                      />
                    </div>
                    ...
                    <div className="flex items-center rounded-xl bg-slate-100 p-0.5 border border-slate-200 text-xs">
                      ...
                      <button
                        ...
                        className={`rounded-lg px-2.5 py-1 font-bold transition-colors ${
                          filterType === 'income' ? 'bg-emerald-600 text-white shadow-2xs' : 'text-slate-600 hover:text-emerald-700'
                        }`}
                      >
                        รายรับ
                      </button>
                      <button
                        ...
                        className={`rounded-lg px-2.5 py-1 font-bold transition-colors ${
                          filterType === 'expense' ? 'bg-rose-600 text-white shadow-2xs' : 'text-slate-600 hover:text-rose-700'
                        }`}
                      >
                        รายจ่าย
                      </button>
                    ...
                    <button
                      ...
                      className="flex items-center gap-1 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-800 px-3 py-1.5 text-xs font-bold border border-slate-200 transition-colors"
                    >
                ...
                {/* Table Container */}
                <div className="overflow-x-auto rounded-2xl border border-slate-200 bg-white shadow-2xs max-h-[380px]">
                  <table className="w-full text-left text-xs text-slate-700">
                    <thead className="sticky top-0 z-10 bg-slate-50 border-b border-slate-200 font-bold text-slate-800">
                      <tr>
                        ...
                        filteredItems.map((item) => (
                          <tr 
                            ...
                            className={`transition-colors ${
                              item.selected ? 'hover:bg-slate-50/80' : 'bg-slate-50/40 opacity-50'
                            }`}
                          >
                            {/* Checkbox */}
                            ...
                            <td className="px-3 py-2">
                              <div className="flex items-center gap-1">
                                <input
                                  ...
                                  className="w-full rounded-lg border border-slate-200 bg-white px-2 py-1 text-xs text-slate-900 focus:border-indigo-600 focus:outline-none"
                                />
                              </div>
                            </td>
                            ...
                            <td className="px-3 py-2">
                              <input
                                ...
                                className="w-full rounded-lg border border-slate-200 bg-white px-2.5 py-1 text-xs text-slate-900 focus:border-indigo-600 focus:outline-none"
                              />
                            </td>
                            ...
                            <td className="px-3 py-2">
                              <select
                                ...
                                className="w-full rounded-lg border border-slate-200 bg-white px-1.5 py-1 text-xs text-slate-900 focus:border-indigo-600 focus:outline-none"
                              >
        ...
        {/* Footer Actions */}
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 border-t border-slate-200 px-6 py-4 bg-slate-50">
            ...
            {parseResult && (
              <>
                <button
                  ...
                  className="flex items-center gap-1.5 rounded-xl border border-slate-300 bg-white px-4 py-2.5 text-xs font-bold text-slate-700 hover:bg-slate-100 transition-colors shadow-2xs"
                >
                ...
                <button
                  ...
                  className="flex items-center gap-2 rounded-xl bg-emerald-600 px-6 py-2.5 text-xs font-bold text-white hover:bg-emerald-700 transition-all shadow-xs disabled:opacity-50"
                >
                  {isSaving ? (
                    <>
